...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-dml-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8336&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-dml-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-dml` can be installed with:

```
conda install r-dml
```

It is possible to list all of the versions of `r-dml` available on your platform with:
